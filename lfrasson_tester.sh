...
#    Updated: 2023/10/09 10:27:44 by mafranco         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
if [ "$FLAG" = "all" ] || [ "$FLAG" = "simple" ]; then
	...
	random_checker "Random list of Five numbers" "(-2..2)" 12
fi
...
if [ "$FLAG" = "all" ] || [ "$FLAG" = "advanced" ]; then
	...
	random_checker "Random list of five hundred numbers -250 to 249" "(-250..249)" 11500
fi
